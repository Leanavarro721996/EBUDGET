<div wire:ignore.self class="modal fade" id="updatesupp" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-m">
        <div class="modal-content">
            <div class="modal-header">
                <text class="modal-title" id="updatesupp"><strong>Supplemental</strong></text>
                        ...
                        <div class="container">
                            <form class="row gx-3 gy-2 align-items-center">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    @error('First Quarter') <span class="text-danger">{{ $message }}</span>@enderror
                                </div>

                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" wire:model="SECOND2" placeholder="SECOND2">
                                    <label for="floatingInput">SECOND</label>
                                    @error('Second Quarter') <span class="text-danger">{{ $message }}</span>@enderror
                                </div>

                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" wire:model="THIRD3" placeholder="THIRD3">
                                    <label for="floatingInput">THIRD</label>
                                    @error('Third Quarter') <span class="text-danger">{{ $message }}</span>@enderror
                                </div>

                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" wire:model="FOURTH4" placeholder="FOURTH4">
                                    <label for="floatingInput">FOURTH</label>
                                    @error('Fourth Quarter') <span class="text-danger">{{ $message }}</span>@enderror
                                </div>
                            </form>
                        </div>
                    </div>
