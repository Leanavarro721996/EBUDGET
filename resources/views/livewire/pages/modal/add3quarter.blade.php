 @include('livewire.pages.modal.messagebox3rd')
 <div wire:ignore.self class="modal fade" id="add3quarter" tabindex="-1" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
     <div class="modal-dialog modal-l">
         <div class="modal-content">
             <div class="modal-header">
                 <text class="modal-title" id="add3quarter"><strong>Quarter</strong></text>
                     ...
                     <div class="card-body">
                         <form form class="row gx-3 gy-2 align-items-center">
                             <div class="border rounded p-3 mb-2">
                                 <label for="floatingInput" class="form-label fw-bold">First Quarter</label>
                             ...
                             <div class="border rounded p-3 mb-2">
                                 ...
                                 <input type="number" class="form-control" wire:model="THIRD" placeholder="Total"
                                     readonly>
                                 <label for="floatingInput" class="ms-2">Total</label>
                                 ...
                                 <div class="form-floating mb-3 d-flex align-items-center gap-2">
                                     ...
                                     <label for="floatingInput" class="ms-2">Remaining Balance</label>
                                     <div class="form-check ms-3">
                                         <input class="form-check-input" type="checkbox" wire:model="thirdChecked"
                                             id="thirdQuarterCheck">
                                     </div>
                                 </div>
                             </div>
                         </form>
             ...
             <div class="modal-footer d-flex justify-content-center">
                 ...
                 <button style="background-color: #206BC4;" type="button" class="btn btn text-white"
                     data-bs-toggle="modal" data-bs-target="#messagebox3rd" title="Deduction Details">
