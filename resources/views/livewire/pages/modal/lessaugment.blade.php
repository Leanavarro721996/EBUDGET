<div wire:ignore.self class="modal fade" id="lessaugment" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-m">
        <div class="modal-content">
            <div class="modal-header">
                <text class="modal-title" id="lessaugment"><strong>Details</strong></text>
            ...
            <div class="modal-body">
                <div class="card">
                    ...
                    <div class="card-header">
                        <strong>Less Augmentation</strong>
                    </div>
